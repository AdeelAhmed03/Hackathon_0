...
Handles Facebook integrations: posts messages and generates engagement summaries.
...
- Invokes social-mcp-fb for posting when approved
- Generates Facebook engagement summaries (SUMMARY_FB_{date}.md)
...
"""
            ...
            if mcp_result["success"]:
                ...
                done_dir = DATA_DIR / "Done" / "local"  # Assuming local handles execution
