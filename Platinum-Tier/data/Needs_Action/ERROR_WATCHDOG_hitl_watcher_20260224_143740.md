...
## Watchdog Alert: [CRITICAL] hitl_watcher Repeatedly Failing

The process **hitl_watcher** (watcher) has failed **11** consecutive times
...
- Manually restart: `python watcher/hitl_watcher.py`
