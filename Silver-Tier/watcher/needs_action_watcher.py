...
DEFAULT_RALPH_COMMAND = os.environ.get(
    "RALPH_COMMAND",
    'claude /ralph-loop "Process all files in data/Needs_Action/ using Functional Assistant (agents/agent-functional-assistant.md). '
    'Also: check data/Approved/ via skill-hitl-watcher and run skill-scheduler time checks." '
